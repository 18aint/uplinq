    ...
    <section className="w-full py-24 relative">
      ...
      <div className="mt-12 flex flex-col items-center">
        ...
        <div className="flex justify-center mt-12">
          <Link
            to="/pricing"
            className="mt-[-50px] font-light inline-flex items-center px-4 py-2 rounded-full bg-blue-500 text-white hover:bg-blue-600 hover:scale-105 transition-all duration-300"
          >
